...
namespace MatchZy
{
    public partial class MatchZy
    {
        ...
        public FakeConVar<bool> matchzy_match_simulate = new("matchzy_match_simulate", "When set to true/1, simulates the entire match: veto for both teams, knife stay/swap, and enables bots. Default: false", false);
